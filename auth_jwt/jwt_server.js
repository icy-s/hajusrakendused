// jwt_server.js - JWT Authentication Server
...
app.post("/api/login", (req, res) => {
  ...
  if (!user){
    ...
    return res.status(401).json({error: "User not found: " + _body.usernrame})
  }
...
const authenticateToken = (req, res, next) => {
  ...
  // verifying if this token is tied to the user, not just random one
